...
parser.add_argument('--cooldown-epochs', type=int, default=80, metavar='N',
                    help='epochs to cooldown LR at min_lr, after cyclic schedule ends')
parser.add_argument('--patience-epochs', type=int, default=60, metavar='N',
...
parser.add_argument('--ratio', type=float, nargs='+', default=[0.8, 1.2], metavar='RATIO',
...
def main(data_ = None,name=None,create_time=0):
    ...
    dataset_train=CheXpert_Dataset.CheXpert_Dataset(neg_one_to_zero=False,transform=train_trans)
    dataset_eval= CheXpert_Dataset.CheXpert_TEST_Dataset(neg_one_to_zero=False,transform=valid_trans)
