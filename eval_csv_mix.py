...
if __name__ == '__main__':
    ...
    test_dataset = ODIR_VALID_DATASET(transform=test_transforms)
    ...
    tst_preds = []
    model_path = ['/disk1/wangjialei/research/odir_main/final_for_paper_backbone/train/20230713-163117-res2net50d-384/checkpoint-21.pth.tar',
    ...
    for i in range(CFG['tta']):
        model = mix_model.Mix_Models_with_Channel_Attention_3_right_final(lock_base=False,load_checkpoint=False)
